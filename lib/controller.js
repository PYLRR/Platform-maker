...
function addSquare(x,y, textureID) {
    ...
    UVcoordinates = [0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0];
...
function keyFunction(e){
    ...
    switch (e.keyCode) {
        case 13:  // enter : add a block with default texture
            addSquare(cursorx, cursory, TextureIDEnum[0]);
            break;
        case 37:  // left
            cursorx -= 1;
            break;
        ...
        case 82:  // r : change texture of a block
            ...
            if(block != null){
                ...
                block.texture = TextureIDEnum[(index+1) % TextureIDEnum.length];
                console.log("texture changed to "+block.texture);
            }else{
                console.log("no block to change texture");
            }
            break;
    }
