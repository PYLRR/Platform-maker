function drawScene() {
    ...
    gl.uniform3f(dirLocation,Math.sin(utils.degToRad(60))*Math.sin(utils.degToRad(45)) ,Math.cos(utils.degToRad(60)),
        Math.sin(utils.degToRad(60))*Math.cos(utils.degToRad(45)));
    gl.uniform4f(lightColorLocation,1.0,1.0,1.0,1.0);
    gl.uniform4f(specularColorLocation,1.0,1.0,1.0,1.0);
    gl.uniform4f(ambientLightColorLocation,0.1,0.1,0.1,1.0);
    gl.uniform1f(specShineLocation,100.0);
    gl.uniform3f(eyePosLocation, cx, cy, cz);
